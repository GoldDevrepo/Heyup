<div class="transactions index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('itunes_product'); ?></th>
			<th><?php echo $this->Paginator->sort('itunes_price'); ?></th>
			<th><?php echo $this->Paginator->sort('android_product'); ?></th>
			<th><?php echo $this->Paginator->sort('android_price'); ?></th>
			<th><?php echo $this->Paginator->sort('creadit'); ?></th>
			<th><?php echo $this->Paginator->sort('amount'); ?></th>
			<th><?php echo $this->Paginator->sort('description'); ?></th>
                        <th><?php echo $this->Paginator->sort('locale'); ?></th>
			<th><?php echo $this->Paginator->sort('time_stamp'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($transaction['Transaction']['itunes_product']); ?>&nbsp;</td>
		<td><?php echo h($transaction['Transaction']['itunes_price']); ?>&nbsp;</td>
		<td><?php echo h($transaction['Transaction']['android_product']); ?>&nbsp;</td>
		<td><?php echo h($transaction['Transaction']['android_price']); ?>&nbsp;</td>
		<td><?php echo h($transaction['Transaction']['creadit']); ?>&nbsp;</td>
		<td><?php echo h($transaction['Transaction']['amount']); ?>&nbsp;</td>
		<td><?php echo h($transaction['Transaction']['description']); ?>&nbsp;</td>
                <td><?php echo h($transaction['Transaction']['locale']); ?>&nbsp;</td>
		<td><?php echo h($transaction['Transaction']['time_stamp']); ?>&nbsp;</td>
